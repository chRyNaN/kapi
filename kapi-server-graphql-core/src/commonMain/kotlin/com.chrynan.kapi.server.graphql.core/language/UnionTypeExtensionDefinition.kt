...
@Serializable
@SerialName(value = "UnionTypeExtensionDefinition")
class UnionTypeExtensionDefinition(
    ...
    ): UnionTypeExtensionDefinition = UnionTypeExtensionDefinition(
    ...
    override fun isContentEqualTo(node: Node): Boolean {
        ...
        if (node !is UnionTypeExtensionDefinition) return false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is UnionTypeExtensionDefinition) return false
