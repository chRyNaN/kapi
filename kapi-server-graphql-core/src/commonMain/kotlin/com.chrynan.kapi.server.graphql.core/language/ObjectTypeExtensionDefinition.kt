...
@Serializable
@SerialName(value = "ObjectTypeExtensionDefinition")
class ObjectTypeExtensionDefinition(
    ...
    override fun isContentEqualTo(node: Node): Boolean {
        ...
        if (node !is ObjectTypeExtensionDefinition) return false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ObjectTypeExtensionDefinition) return false
