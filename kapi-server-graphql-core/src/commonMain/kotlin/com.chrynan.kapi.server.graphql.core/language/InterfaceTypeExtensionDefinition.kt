...
@Serializable
@SerialName(value = "InterfaceTypeExtensionDefinition")
class InterfaceTypeExtensionDefinition(
    ...
    ): InterfaceTypeExtensionDefinition = InterfaceTypeExtensionDefinition(
        name = name,
    ...
    override fun isContentEqualTo(node: Node): Boolean {
        ...
        if (node !is InterfaceTypeExtensionDefinition) return false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is InterfaceTypeExtensionDefinition) return false
