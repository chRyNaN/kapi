...
@Serializable
@SerialName(value = "EnumTypeExtensionDefinition")
class EnumTypeExtensionDefinition(
    ...
    ): EnumTypeExtensionDefinition = EnumTypeExtensionDefinition(
        name = name,
        values = values,
    ...
    override fun isContentEqualTo(node: Node): Boolean {
        ...
        if (node !is EnumTypeExtensionDefinition) return false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is EnumTypeExtensionDefinition) return false
